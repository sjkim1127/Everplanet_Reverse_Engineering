# Quick Attach MINIMAL - patchnote.md 패치만 적용
$ProjectRoot = Split-Path $PSScriptRoot -Parent
$gamePath = Join-Path $ProjectRoot "EverPlanet\EverPlanet_KR_v1842_U_DEVM.exe"
$scriptPath = Join-Path $ProjectRoot "frida\hook_minimal.js"
...
Write-Host "[*] Attaching Frida (MINIMAL) to PID: $($proc.Id)" -ForegroundColor Green
